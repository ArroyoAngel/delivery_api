...
export class PaymentEntity {
  ...
  @Column({ name: 'total_amount', type: 'decimal', precision: 10, scale: 2, default: 0 }) totalAmount: number;
  @Column({ name: 'bank_provider', type: 'varchar', nullable: true }) bankProvider: string | null;
  @Column({ name: 'bank_transaction_id', type: 'varchar', nullable: true }) bankTransactionId: string | null;
