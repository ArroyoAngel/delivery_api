...
export class OrderEntity {
  ...
  @Column({ name: 'delivery_lat', type: 'decimal', precision: 10, scale: 7, nullable: true }) deliveryLat: number;
  @Column({ name: 'delivery_lng', type: 'decimal', precision: 10, scale: 7, nullable: true }) deliveryLng: number;
  ...
  @Column({ name: 'payment_reference', nullable: true, unique: true }) paymentReference: string;
